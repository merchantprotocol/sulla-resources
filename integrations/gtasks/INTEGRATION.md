---
slug: gtasks
name: google-tasks-v1
type: proxy
auth_type: oauth2
---

# google-tasks-v1 Integration
...
```
sulla <account_id>/gtasks '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"gtasks"}'
```
...
### List resources
```bash
sulla <account_id>/gtasks '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/gtasks '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
