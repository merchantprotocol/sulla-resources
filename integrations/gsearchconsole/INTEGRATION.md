---
slug: gsearchconsole
name: google-searchconsole-v1
type: proxy
auth_type: oauth2
---

# google-searchconsole-v1 Integration
...
```
sulla <account_id>/gsearchconsole '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"gsearchconsole"}'
```
...
### List resources
```bash
sulla <account_id>/gsearchconsole '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/gsearchconsole '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
