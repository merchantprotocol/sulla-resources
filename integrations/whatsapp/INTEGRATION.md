---
slug: whatsapp
name: whatsapp-cloud-v21
type: proxy
auth_type: bearer
---

# whatsapp-cloud-v21 Integration
...
```
sulla <account_id>/whatsapp '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"whatsapp"}'
```
...
### List resources
```bash
sulla <account_id>/whatsapp '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/whatsapp '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
