---
slug: meta-ads
name: meta-marketing-v21
type: proxy
auth_type: oauth2
---

# meta-marketing-v21 Integration
...
```
sulla <account_id>/meta-ads '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"meta-ads"}'
```
...
### List resources
```bash
sulla <account_id>/meta-ads '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/meta-ads '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
