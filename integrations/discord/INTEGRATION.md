---
slug: discord
name: discord-bot-v10
type: proxy
auth_type: apiKey
---

# discord-bot-v10 Integration
...
```
sulla <account_id>/discord '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"discord"}'
```
...
### List resources
```bash
sulla <account_id>/discord '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/discord '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
