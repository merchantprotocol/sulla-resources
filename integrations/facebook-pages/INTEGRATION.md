---
slug: facebook-pages
name: facebook-pages-v21
type: proxy
auth_type: bearer
---

# facebook-pages-v21 Integration
...
```
sulla <account_id>/facebook-pages '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"facebook-pages"}'
```
...
### List resources
```bash
sulla <account_id>/facebook-pages '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/facebook-pages '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
