---
slug: instagram
name: instagram-graph-v21
type: proxy
auth_type: bearer
---

# instagram-graph-v21 Integration
...
```
sulla <account_id>/instagram '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"instagram"}'
```
...
### List resources
```bash
sulla <account_id>/instagram '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/instagram '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
