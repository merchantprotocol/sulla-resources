...
```
sulla <account_id>/telegram '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"telegram"}'
```
...
### List resources
```bash
sulla <account_id>/telegram '{"method":"GET","path":"/"}'
```
