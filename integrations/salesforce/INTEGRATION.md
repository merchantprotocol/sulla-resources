---
slug: salesforce
name: salesforce-rest-v62
type: proxy
auth_type: bearer
---

# salesforce-rest-v62 Integration
...
```
sulla <account_id>/salesforce '<json_body>'
```
...
```bash
sulla vault/list_accounts '{"account_type":"salesforce"}'
```
...
### List resources
```bash
sulla <account_id>/salesforce '{"method":"GET","path":"/"}'
```

### Create a resource
```bash
sulla <account_id>/salesforce '{
  "method": "POST",
  "path": "/resource",
  "body": {"key": "value"}
}'
